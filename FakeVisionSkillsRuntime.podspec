...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FakeVisionSkillsRuntime.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Wei-Chih Chen/FakeVisionSkillsRuntime'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Wei-Chih Chen' => 'weicch@microsoft.com' }
  s.source           = { :git => 'https://github.com/Wei-Chih Chen/FakeVisionSkillsRuntime.git', :tag => s.version.to_s }
